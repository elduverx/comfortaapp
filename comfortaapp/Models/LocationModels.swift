...
public struct Trip: Codable, Identifiable, Equatable {
    public let id = UUID()
    public let pickup: LocationPoint
    ...
    public init(pickup: LocationPoint, destination: LocationPoint, distance: Double, estimatedFare: Double, estimatedDuration: TimeInterval, status: TripStatus, createdAt: Date) {
        self.pickup = pickup
    ...
    public var formattedFare: String {
        estimatedFare.formatted(.currency(code: "EUR").locale(Locale(identifier: "es_ES")))
    }
    ...
    public var formattedDuration: String {
        ...
        return formatter.string(from: estimatedDuration) ?? ""
    }
}
